...
namespace GestCand.Controllers
{
    public class CandidatsController : Controller
    {
        private readonly GestCandContext _context;

        public CandidatsController(GestCandContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Postnom,Prenom,Sexe,LieuNaissance,DateNaissance,Nationalite,Adresse,Telephone")] Candidat candidat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Postnom,Prenom,Sexe,LieuNaissance,DateNaissance,Nationalite,Adresse,Telephone")] Candidat candidat)
        {
            if (id != candidat.Id)
            {
                return NotFound();
